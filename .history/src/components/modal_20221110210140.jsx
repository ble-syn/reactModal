      ...
      {!showModal && (
        <div className="modal-content">
          ...
          <div className="copy-cont content">
            <input onChange={copyToClipboard} className="link-copy" value="app.untitledui.com/integrations/intercom"  />
            <button className="btn cen-item"> <span><FiCopy /> </span> Copy link</button>
          </div>
